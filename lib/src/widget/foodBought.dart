...
class BoughtFood extends StatefulWidget
{
  ...
  BoughtFood({required this.id,required this.name,required this.category,required this.imagePath,required this.discount,required this.price,required this.ratings});
}
